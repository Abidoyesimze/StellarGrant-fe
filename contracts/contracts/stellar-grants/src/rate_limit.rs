...
use crate::constants::{
    ...
    RATE_LIMIT_MILESTONE_SUBMIT_WINDOW, RATE_LIMIT_SNAPSHOT_CAPTURE_MAX,
    RATE_LIMIT_SNAPSHOT_CAPTURE_WINDOW, RATE_LIMIT_WAITLIST_JOIN_MAX,
...
pub fn limit_for(action: &RateLimitAction) -> (u32, u64) {
    match action {
        ...
        RateLimitAction::SnapshotCapture => (
            RATE_LIMIT_SNAPSHOT_CAPTURE_MAX,
            RATE_LIMIT_SNAPSHOT_CAPTURE_WINDOW,
        ),
    }
}
